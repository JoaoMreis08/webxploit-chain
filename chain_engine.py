...
_CHAIN_RULES: list[tuple[VulnType, VulnType, dict]] = [
    ...
    (VulnType.XSS, VulnType.AUTH_BYPASS, {
    ...
    # SQLi chains
    (VulnType.SQLI, VulnType.AUTH_BYPASS, {
    ...
    (VulnType.SQLI, VulnType.RCE, {
        ...
        "prerequisites": ["FILE privilege (MySQL) OR sysadmin role (MSSQL)", "writable web root"],
        "severity_bump": 4,
        "confidence":    0.7,
        "tags":          ["rce", "file-write", "database"],
    }),
    (VulnType.SQLI, VulnType.INFO_DISCLOSURE, {
    ...
    (VulnType.SSRF, VulnType.RCE, {
        ...
        "prerequisites": ["Redis/Memcached without auth on internal network", "Gopher protocol enabled"],
        "severity_bump": 4,
        "confidence":    0.65,
        "tags":          ["gopher", "redis", "rce"],
    }),
    (VulnType.SSRF, VulnType.INFO_DISCLOSURE, {
    ...
    # IDOR chains
    (VulnType.IDOR, VulnType.INFO_DISCLOSURE, {
    ...
    (VulnType.IDOR, VulnType.AUTH_BYPASS, {
    ...
    (VulnType.LFI, VulnType.INFO_DISCLOSURE, {
    ...
    # Auth bypass chains
    (VulnType.AUTH_BYPASS, VulnType.PRIV_ESC, {
    ...
    (VulnType.AUTH_BYPASS, VulnType.RCE, {
    ...
    (VulnType.OPEN_REDIRECT, VulnType.AUTH_BYPASS, {
    ...
    (VulnType.XXE, VulnType.INFO_DISCLOSURE, {
    ...
    # Deserialisation
    (VulnType.DESERIALISATION, VulnType.RCE, {
    ...
    (VulnType.INFO_DISCLOSURE, VulnType.AUTH_BYPASS, {
...
class ChainEngine:
    ...
    def analyse(
        ...
        logger.info("Chain engine found %d unique chains from %d findings.", len(ranked), len(findings))
        return ranked
